...
public class VerificationCreator extends Creator<Verification> {
     ...
     *
     * @param hashMap Channel specific configuration in json format.
     * @return this
     */
    public VerificationCreator setChannelConfiguration(final HashMap<String, Object> hashMap) {
        this.channelConfiguration = hashMap;
        return this;
    }
     ...
     * Example SMS body: `&lt;#&gt; Your AppName verification code is: 1234
     * He42w354ol9`..
     *
    ...
    public Verification create(final TwilioRestClient client) {
        Request request = new Request(HttpMethod.POST, Domains.VERIFY.toString(),
                "/v2/Services/" + this.pathServiceSid + "/Verifications", client.getRegion());
